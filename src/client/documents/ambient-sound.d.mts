import AmbientSound from "./../canvas/placeables/sound.mjs";
...
export default class AmbientSoundDocument<TParent extends Scene | null = Scene | null> extends CanvasBaseAmbientSound<TParent> {}

export default interface AmbientSoundDocument<TParent extends Scene | null = Scene | null> extends CanvasBaseAmbientSound<TParent> {
