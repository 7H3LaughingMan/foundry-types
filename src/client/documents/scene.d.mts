...
import { RegionSurface, SceneDimensions, SceneViewOptions, TokenMovementInstruction, TokenMovementOptions, TokenResizingInstruction } from "./_types.mjs";
...
export default class Scene extends ClientBaseScene {
     ...
     */
    getSurfaces(options: { type?: EdgeRestrictionType; level?: Level | string; occlusion?: boolean; exposure?: boolean }): DeepReadonly<RegionSurface[]>;
...
export type SceneEmbeddedName = "AmbientLight" | "AmbientSound" | "Drawing" | "MeasuredTemplate" | "Level" | "Note" | "Region" | "Tile" | "Token" | "Wall";
