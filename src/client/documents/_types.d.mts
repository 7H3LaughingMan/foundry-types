import { TokenConstrainMovementPathOptions, TokenCreateTerrainMovementPathOptions, TokenMovementActionConfig, TokenPanningOptions } from "#client/_types.mjs";
...
export interface ActiveEffectChangeData<TEffect extends ActiveEffect<any> = ActiveEffect<any>> extends EffectChangeData {
    key?: string;
    effect?: TEffect;
    priority: number;
}
