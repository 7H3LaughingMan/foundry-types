...
declare const ClientBaseCombatantGroup: new <TParent extends Combat | null>(...args: any) => BaseCombatantGroup<TParent> & ClientDocument<TParent>;

interface ClientBaseCombatantGroup<TParent extends Combat | null> extends InstanceType<typeof ClientBaseCombatantGroup<TParent>> {}
 ...
 */
export default class CombatantGroup<TParent extends Combat | null = Combat | null> extends ClientBaseCombatantGroup<TParent | null> {
    /**
