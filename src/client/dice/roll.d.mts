...
export default class Roll {
     ...
     */
    toMessage(messageData: DeepPartial<ChatMessageSource> | undefined, options?: { messageMode?: ChatMessageMode; create: false }): Promise<ChatMessageSource>;
    toMessage(messageData?: DeepPartial<ChatMessageSource>, options?: { messageMode?: ChatMessageMode; create?: true }): Promise<ChatMessage>;
    toMessage(
