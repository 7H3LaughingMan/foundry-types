 ...
 */
export class ShapeControls<TDocument extends Document = Document, TObject extends PlaceableObject = PlaceableObject> extends RenderFlagsMixin(PIXI.Container) {
    /**
     ...
     */
    protected _prepareDragDropUpdate(event: PlaceablesLayerPointerEvent<TObject>): { shape: object } | { shapes: object };
