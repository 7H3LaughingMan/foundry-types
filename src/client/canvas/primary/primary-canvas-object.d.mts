 ...
 * @mixin
 */
export default function PrimaryCanvasObjectMixin<TBase extends ConstructorOf<PIXI.DisplayObject>>(DisplayObject: TBase): typeof PrimaryCanvasObject & TBase;
 ...
 * @param DisplayObject The parent DisplayObject class being mixed
 */
export function CanvasTransformMixin<TBase extends ConstructorOf<PIXI.DisplayObject>>(DisplayObject: TBase): typeof CanvasTransformObject & TBase;
