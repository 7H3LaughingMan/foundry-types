...
export default class RegionLayer<TObject extends Region = Region> extends PlaceablesLayer<TObject> {
     ...
     * ```
     */
    placeRegion(data: DeepPartial<RegionSource>, options?: RegionPlacementOptions<TObject>): Promise<TObject["document"] | null>;
     ...
     */
    placeRegions(data: Iterable<DeepPartial<RegionSource>>, options?: RegionPlacementOptions<TObject>): Promise<TObject["document"][] | null>;
