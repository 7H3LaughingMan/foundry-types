...
import { CanvasBackgroundAlterationEffects, CanvasColorationEffects, CanvasDarknessEffects, CanvasIlluminationEffects } from "../layers/_module.mjs";
 ...
 */
export default class EffectsCanvasGroup<TObject extends AmbientLight | Token = AmbientLight | Token> extends CanvasGroupMixin(PIXI.Container) {
    /**
