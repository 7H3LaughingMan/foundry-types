...
import RenderedEffectSource, { RenderedEffectLayerConfig, RenderedEffectSourceData, RenderedEffectSourceLayer } from "./rendered-effect-source.mjs";

declare const RenderedPointEffectSource: {
    new <TObject extends AmbientLight | Token, TData extends RenderedEffectSourceData>(...args: any): RenderedEffectSource<TObject, TData> & PointEffectSource;
} & Omit<typeof RenderedEffectSource, "new"> &
    typeof PointEffectSource;

interface RenderedPointEffectSource<TObject extends AmbientLight | Token, TData extends RenderedEffectSourceData> extends InstanceType<
    typeof RenderedPointEffectSource<TObject, TData>
> {}
...
export default class PointVisionSource<TObject extends AmbientLight | Token> extends RenderedPointEffectSource<TObject, VisionSourceData> {
