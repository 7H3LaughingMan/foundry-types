...
import { Actor, ChatMessage, Combat, Item, JournalEntry, JournalEntryPage, Macro, Scene, TokenDocument, User } from "#client/documents/_module.mjs";
...
export default class Hooks {
    ...
    static on(...args: HookParamsRender<JournalPageSheet<JournalEntryPage<JournalEntry | null>>, "JournalPageSheet">): number;
    static on(...args: HookParamsRender<JournalTextPageSheet<JournalEntryPage<JournalEntry | null>>, "JournalTextPageSheet">): number;
    ...
    static once(...args: HookParamsRender<JournalPageSheet<JournalEntryPage<JournalEntry | null>>, "JournalPageSheet">): number;
    static once(...args: HookParamsRender<JournalTextPageSheet<JournalEntryPage<JournalEntry | null>>, "JournalTextPageSheet">): number;
