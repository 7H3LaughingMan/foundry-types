 ...
 * ```
 */
export function mergeObject<T extends object, U extends object = T>(original: T, other?: U | undefined, options?: MergeObjectOptions, _d?: number): T & U;
 ...
 */
export function buildUuid(context: { id: string; documentName?: string; parent?: Document | null; pack?: string | null }): string | null;
