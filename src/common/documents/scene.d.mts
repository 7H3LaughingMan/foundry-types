...
import { GridType, ImageFilePath } from "#common/constants.mjs";
...
type SceneSchema = {
    ...
    shiftX: fields.NumberField<number, number, true, false, true>;
    shiftY: fields.NumberField<number, number, true, false, true>;
    ...
    levels: fields.EmbeddedCollectionDeltaField<documents.BaseLevel<BaseScene>>;
...
type FogSchema = {
    mode: fields.NumberField<0 | 1 | 2, 0 | 1 | 2, true, false, true>;
