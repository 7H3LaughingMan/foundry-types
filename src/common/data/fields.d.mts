...
> implements Omit<DataFieldOptions<TSourceProp, TRequired, TNullable, THasInitial>, "validate"> {
     ...
     * @param parts The field path or property key if `source` is passed as an array of strings (in reverse order)
     ...
     * @param _state Internal state variables which are used during recursion
     * @returns The cleaned value
     */
    clean(value: unknown, options?: DataModelCleaningOptions, _state?: DataModelUpdateState): MaybeSchemaProp<TSourceProp, TRequired, TNullable, THasInitial>;
     ...
     *
     *
     * @param value Candidate source value for the field
     * @param options Options for how the field is cleaned
     * @param _state Internal state variables transacted during cleaning recursion.
     * @returns A migrated value suitable for cleaning
     */
    protected _migrate(value: unknown, options: Readonly<DataModelCleaningOptions>, _state: DataModelUpdateState): unknown;
     ...
     * @returns The cleaned value.
     */
    protected _cleanType(value: unknown, options: Readonly<DataModelCleaningOptions>, _state: DataModelUpdateState): unknown;

    /**
     * Apply special sanitization workflows to this value.
     * This method is reserved for implementation in server-side workflows.
     * @param value A candidate value that has been cast and cleaned
     * @param options Options for how the field is sanitized
     * @param _state Internal state variables which are used during recursion
     * @returns The sanitized value
     */
    protected _sanitize(value: unknown, options: Readonly<DataModelSanitizationOptions>, _state: DataModelUpdateState): unknown;
     ...
     * ```
     */
    validators(options?: Pick<DataFieldValidationOptions, "phase" | "recursive">): Generator<(value: unknown) => boolean | undefined>;
     ...
     * @returns A failure that occurred if validation is non-strict. The failure may have been resolved by fallback or
     ...
     * @throws An error with a specific reason the value is invalid
     */
    protected _validateType(value: unknown, options?: DataFieldValidationOptions): boolean | DataModelValidationFailure | void;
     ...
     * @throws An error with a specific reason the value is invalid
     */
    protected _validateRecursive(value: unknown, options?: DataFieldValidationOptions): boolean | void;
     ...
     */
    initialize(value: unknown, model?: abstract.DataModel, options?: object): MaybeSchemaProp<TModelProp, TRequired, TNullable, THasInitial>;
     ...
     * @internal
     */
    _updateDiff(source: object, key: string, value: unknown, difference: object, options: abstract.DataModelUpdateOptions): void;
     ...
     * @internal
     */
    _updateCommit(source: object, key: string, value: object, diff: object, options: abstract.DataModelUpdateOptions): void;
     ...
     * @param options Additional options to configure the data replacement
     * @param options.strict Throw an Error if data replacement fails
     * @returns The expression with data references resolved
     */
    protected _replaceDataRefs(raw: string, data: Record<string, unknown>, options?: { strict?: boolean }): string;
     ...
     * @returns The updated value.
     */
    protected _applyChangeAdd(value: unknown, delta: unknown, model: abstract.DataModel, change: EffectChangeData): unknown;
     ...
     * @returns The updated value.
     */
    protected _applyChangeSubtract(value: unknown, delta: unknown, model: abstract.DataModel, change: EffectChangeData): unknown;
     ...
     * @returns The updated value.
     */
    protected _applyChangeMultiply(value: unknown, delta: unknown, model: abstract.DataModel, change: EffectChangeData): unknown;
     ...
     * @returns The updated value.
     */
    protected _applyChangeOverride(value: unknown, delta: unknown, model: abstract.DataModel, change: EffectChangeData): unknown;
     ...
     * @returns The updated value.
     */
    protected _applyChangeUpgrade(value: unknown, delta: unknown, model: abstract.DataModel, change: EffectChangeData): unknown;
     ...
     * @returns The updated value.
     */
    protected _applyChangeDowngrade(value: unknown, delta: unknown, model: abstract.DataModel, change: EffectChangeData): unknown;
     ...
     * @returns The updated value.
     */
    protected _applyChangeCustom(value: unknown, delta: unknown, model: abstract.DataModel, change: EffectChangeData): unknown;
}
...
> extends DataField<TSourceProp, TModelProp, TRequired, TNullable, THasInitial> {
     ...
     * @param context Additional context which describes the field
     */
    constructor(fields: TDataSchema, options?: DataFieldOptions<TSourceProp, TRequired, TNullable, THasInitial>, context?: DataFieldContext);
     ...
     */
    protected _initialize(fields: abstract.DataSchema): TDataSchema;

    /**
     * Extend this schema definition with additional fields.
     * @param fields The additional fields.
     */
    extendFields(fields: abstract.DataSchema): void;
     ...
     * @param pathOrKey A field path or property key if `options.source` is given. Examples: `["abilities", "strength"]`
     *                  or `"abilities.strength"`.
     * @param options Additional options
     * @param options.source The source data of the field
     * @returns The corresponding DataField definition for that field, or undefined
     */
    ...
    override getInitialValue(data?: object): MaybeSchemaProp<TSourceProp, TRequired, TNullable, THasInitial>;
     ...
     */
    static reconstructOperator(data: object, k: string, v: unknown): void;
    ...
    override _updateDiff(source: object, key: string, value: unknown, difference: object, options: abstract.DataModelUpdateOptions): void;

    override _updateCommit(source: object, key: string, value: object, diff: object, options: abstract.DataModelUpdateOptions): void;

    /* -------------------------------------------- */
    /*  Data Validation                             */
    /* -------------------------------------------- */

    protected override _validateType(data: object, options?: DataFieldValidationOptions): boolean | DataModelValidationFailure | void;
     ...
     * @param field The child data field being handled
     * @param data Data attempted for validation at the parent level
     * @param key The key of this field being validated
     * @param parentFailure The validation failure at the parent level
     * @param fieldFailure The validation failure at this field level
    ...
    static _handleValidationFailure(
        ...
        options: Partial<abstract.DataModelValidationOptions>,
    ): void;

    override _validateModel(data: TSourceProp, options?: DataFieldValidationOptions): void;
    ...
    protected override _applyChangeAdd(value: unknown, delta: unknown, model: abstract.DataModel, change: EffectChangeData): unknown;
}
    ...
    implements Omit<ObjectFieldOptions<TSourceProp, TRequired, TNullable, THasInitial>, "initial" | "validate">
{
    ...
    protected override _validateType(value: unknown, options?: DataFieldValidationOptions): asserts value is Record<string, unknown>;
}
...
export class TypedObjectField<
    ...
    TNullable extends boolean = false,
    THasInitial extends boolean = true,
> extends ObjectField<Record<string, SourceFromDataField<TField>>, Record<string, ModelPropFromDataField<TField>>, TRequired, TNullable, THasInitial> {
    /**
     * @param element The value type of each entry in this object.
     * @param options Options which configure the behavior of the field.
     * @param context Additional context which describes the field
     */
    constructor(element: TField, options?: ObjectFieldOptions<Record<string, SourceFromDataField<TField>>>, context?: DataFieldContext);
    ...
    override _validateModel(changes: Record<string, SourceFromDataField<TField>>, options?: DataFieldValidationOptions): void;
    ...
    implements Omit<ArrayFieldOptions<TSourceProp, TRequired, TNullable, THasInitial>, "validate">
{
     ...
     * @param context Additional context which describes the field
     */
    constructor(element: TElementField, options?: ArrayFieldOptions<TSourceProp, TRequired, TNullable, THasInitial>, context?: DataFieldContext);

    protected static override get _defaults(): ArrayFieldOptions<unknown[], true, false, true>;
     ...
     */
    protected static _validateElementType(element: unknown): DataField;

    override getInitialValue(data?: object): ResolveNullable<ResolveRequired<TSourceProp, TRequired, THasInitial>, TNullable>;
     ...
     * @param value Unclean data for the array entry
     * @param options Options which control how data is cleaned
     * @param _state State used during data cleaning
    ...
    override _castChangeDelta(delta: unknown): unknown;

    protected override _applyChangeAdd(value: unknown[], delta: unknown, model: abstract.DataModel, change: EffectChangeData): unknown[];

    protected override _applyChangeSubtract(value: unknown, delta: unknown, model: abstract.DataModel, change: EffectChangeData): unknown;
}
...
export interface ArrayField<
    ...
    THasInitial extends boolean = TRequired,
> extends DataField<TSourceProp, TModelProp, TRequired, TNullable, THasInitial> {
    clean(value: unknown, options?: DataModelCleaningOptions): MaybeSchemaProp<TSourceProp, TRequired, TNullable, THasInitial>;
}
...
/**
 * A subclass of SchemaField that represents the root schema node of a DataModel.
 */
export class DataModelSchemaField<
    TDataSchema extends abstract.DataSchema = abstract.DataSchema,
    TSourceProp extends SourceFromSchema<TDataSchema> = SourceFromSchema<TDataSchema>,
    TModelProp extends NonNullable<JSONValue> = ModelPropsFromSchema<TDataSchema>,
    TRequired extends boolean = true,
...
> extends SchemaField<TDataSchema, TSourceProp, TModelProp, TRequired, TNullable, THasInitial> {
    ...
    override _cast(value: object): object;

    protected override _migrate(value: unknown, options: DataModelCleaningOptions, _state: DataModelUpdateState): unknown;
}
...
export class EmbeddedDataField<
    ...
    TNullable extends boolean = false,
    THasInitial extends boolean = true,
> extends SchemaField<TModelProp["schema"]["fields"], TModelProp["_source"], TModelProp, TRequired, TNullable, THasInitial> {
    /**
     * @param model The class of DataModel which should be embedded in this field
     * @param options Options which configure the behavior of the field
     * @param context Additional context which describes the field
    ...
    override toObject(value: TModelProp): MaybeSchemaProp<SourceFromSchema<TModelProp["schema"]["fields"]>, TRequired, TNullable, THasInitial>;
}
...
export class EmbeddedCollectionField<
    ...
    TNullable extends boolean = false,
    THasInitial extends boolean = true,
> extends ArrayField<TDocument["schema"], TSourceProp, abstract.EmbeddedCollection<TDocument>, TRequired, TNullable, THasInitial> {
    /**
     * @param element The type of Document which belongs to this embedded collection
     * @param options Options which configure the behavior of the field
     * @param context Additional context which describes the field
     */
    constructor(element: ConstructorOf<Document>, options?: ArrayFieldOptions<TSourceProp, TRequired, TNullable, THasInitial>, context?: DataFieldContext);

    static override _validateElementType(element: unknown): DataField;
    ...
    protected override _cleanType(value: unknown, options?: DataModelCleaningOptions): MaybeSchemaProp<TSourceProp, TRequired, TNullable, THasInitial>;
    ...
    override toObject(value: abstract.EmbeddedCollection<TDocument>): MaybeSchemaProp<TSourceProp, TRequired, TNullable, THasInitial>;
...
export class ColorField<TRequired extends boolean = false, TNullable extends boolean = true, THasInitial extends boolean = true> extends StringField<
    HexColorString,
    Color,
    TRequired,
    TNullable,
...
> extends StringField<TSourceProp, TModelProp, TRequired, TNullable, THasInitial> {
     ...
     * @param context Additional context which describes the field
     * */
    constructor(options?: FilePathFieldOptions<TSourceProp, TRequired, TNullable, THasInitial>, context?: DataFieldContext);
 ...
 */
export class AngleField<TRequired extends boolean = true, TNullable extends boolean = false, THasInitial extends boolean = true> extends NumberField<
    number,
    number,
    TRequired,
    TNullable,
...
export class AlphaField<TRequired extends boolean = true, TNullable extends boolean = false, THasInitial extends boolean = true> extends NumberField<
    number,
    number,
    TRequired,
    TNullable,
 ...
 */
export class HueField<TRequired extends boolean = true, TNullable extends boolean = false, THasInitial extends boolean = true> extends NumberField<
    number,
    number,
    TRequired,
    TNullable,
...
> extends StringField<string, TModelProp, TRequired, TNullable, THasInitial> {
    ...
    override clean(value: unknown, options?: DataModelCleaningOptions): MaybeSchemaProp<string, TRequired, TNullable, THasInitial>;

    protected override _validateType(value: unknown): boolean;

    override initialize(value: MaybeSchemaProp<JSONValue, TRequired, TNullable, THasInitial>): MaybeSchemaProp<TModelProp, TRequired, TNullable, THasInitial>;
...
export class AnyField extends DataField {
    ...
    protected override _validateType(value: unknown, options?: DataFieldValidationOptions): boolean | DataModelValidationFailure | void;
}
...
export class IntegerSortField<TRequired extends boolean = true, TNullable extends boolean = false, THasInitial extends boolean = true> extends NumberField<
    number,
    number,
    TRequired,
    TNullable,
 ...
 */
export class DocumentFlagsField extends TypedObjectField<ObjectField<Record<string, unknown>, Record<string, unknown>, true, false, true>> {
    /**
     * @param options Options which configure the behavior of the field
     * @param context Additional context which describes the field
     */
    constructor(options?: ObjectFieldOptions<Record<string, Record<string, JSONValue | undefined>>, true, false, true>, context?: DataFieldContext);
 ...
 * @mixes DocumentStats
 */
export class DocumentStatsField<TDocumentUUID extends DocumentUUID = DocumentUUID> extends SchemaField<DocumentStatsSchema<TDocumentUUID>> {
...
> extends ObjectField<TSourceProp, TModelProp> {
     ...
     * @param context Additional context which describes the field
     */
    constructor(document: ConstructorOf<TDocument>, options?: ObjectFieldOptions<TSourceProp, true, false, true>, context?: DataFieldContext);
    ...
    protected override _cleanType(value: unknown, options?: DataModelCleaningOptions): TSourceProp;
    ...
    protected override _validateType(data: unknown, options?: DataFieldValidationOptions): void | DataModelValidationFailure;
...
/** A subclass of {@link DataField} which allows to typed schemas. */
export class TypedSchemaField<
    ...
    TNullable extends boolean = false,
    THasInitial extends boolean = false,
> extends DataField<SourceFromTypedSchemaTypes<TTypes>, ModelFromTypedSchemaTypes<TTypes>, TRequired, TNullable, THasInitial> {
    /**
     * @param types The different types this field can represent.
     * @param options Options which configure the behavior of the field
     * @param context Additional context which describes the field
     */
    constructor(types: TTypes, options?: DataFieldOptions<SourceFromTypedSchemaTypes<TTypes>, TRequired, TNullable, THasInitial>, context?: DataFieldContext);
    ...
    protected override _cleanType(value: JSONValue | undefined, options: DataModelCleaningOptions): JSONValue | undefined;
    ...
    override toObject(value: ModelFromTypedSchemaTypes<TTypes>): MaybeSchemaProp<SourceFromTypedSchemaTypes<TTypes>, TRequired, TNullable, THasInitial>;
...
type SourceMapFromTypedSchemaTypes<TTypes extends Record<string, abstract.DataSchema | SchemaField | ConstructorOf<abstract.DataModel>>> = {
...
type SourceFromTypedSchemaTypes<TTypes extends Record<string, abstract.DataSchema | SchemaField | ConstructorOf<abstract.DataModel>>> =
    SourceMapFromTypedSchemaTypes<TTypes>[keyof TTypes];

type ModelMapFromTypedSchemaTypes<TTypes extends Record<string, abstract.DataSchema | SchemaField | ConstructorOf<abstract.DataModel>>> = {
    [K in keyof TTypes]: TTypes[K] extends ConstructorOf<abstract.DataModel>
...
type ModelFromTypedSchemaTypes<TTypes extends Record<string, abstract.DataSchema | SchemaField | ConstructorOf<abstract.DataModel>>> =
    ModelMapFromTypedSchemaTypes<TTypes>[keyof TTypes];

/** A subclass of {@link StringField} which contains JavaScript code. */
export class JavaScriptField<TRequired extends boolean = true, TNullable extends boolean = false, THasInitial extends boolean = false> extends StringField<
    string,
    string,
    TRequired,
    TNullable,
 ...
 */
export class ShapesField<TRequired extends boolean = true, TNullable extends boolean = false, THasInitial extends boolean = true> extends ArrayField<
...
> {
     ...
     */
    constructor(
        options?: ArrayFieldOptions<SourceFromDataField<ArrayField<TypedSchemaField<typeof BaseShapeData.TYPES>>>, TRequired, TNullable, THasInitial>,
        context?: DataFieldContext,
    );

    override initialize(
        value: MaybeSchemaProp<SourceFromDataField<ArrayField<TypedSchemaField<typeof BaseShapeData.TYPES>>>, TRequired, TNullable, THasInitial>,
        model: abstract.DataModel,
        options: ArrayFieldOptions<SourceFromDataField<ArrayField<TypedSchemaField<typeof BaseShapeData.TYPES>>>, TRequired, TNullable, THasInitial>,
    ): MaybeSchemaProp<ModelPropFromDataField<ArrayField<TypedSchemaField<typeof BaseShapeData.TYPES>>>, TRequired, TNullable, THasInitial>;
}
 ...
 */
export class GridOffsetsField<TRequired extends boolean = true, TNullable extends boolean = false, THasInitial extends boolean = false> extends ArrayField<
    GridOffsetField,
    SourceFromSchema<GridOffsetSchema>[],
    ModelPropsFromSchema<GridOffsetSchema>[],
    TRequired,
...
export type MaybeSchemaProp<TProp, TRequired extends boolean, TNullable extends boolean, THasInitial extends boolean> = ResolveNullable<
    ResolveRequired<TProp, TRequired, THasInitial>,
    TNullable
>;
