...
declare global {
    namespace ClipperLib {
        ...
        type ClipType = (typeof ClipType)[keyof typeof ClipType];

        const PolyType: {
            ptSubject: 0;
            ptClip: 1;
        };
        type PolyType = (typeof PolyType)[keyof typeof PolyType];
        ...
        type PolyFillType = (typeof PolyFillType)[keyof typeof PolyFillType];
        ...
        type EndType = (typeof EndType)[keyof typeof EndType];

        const EdgeSide: {
            esLeft: 0;
            esRight: 1;
        };
        type EdgeSide = (typeof EdgeSide)[keyof typeof EdgeSide];
        ...
        class Clipper extends ClipperBase {
            ...
            GetHorzDirection(HorzEdge: TEdge, $val: { Left?: number | undefined; Right?: number | undefined; Dir?: Direction }): void;
            ...
            GetOverlap(a1: IntPoint, a2: IntPoint, b1: IntPoint, b2: IntPoint, $val: { Left?: number | undefined; Right?: number | undefined }): boolean;
            ...
            static AddPolyNodeToPaths(polynode: PolyNode, nt: (typeof Clipper.NodeType)[keyof typeof Clipper.NodeType], paths: Paths): void;
